...
import '../widget/poke_info.dart';
import '../widget/poke_type_name.dart';

class DetailPage extends StatelessWidget {
  final PokemonModel pokemon1;

  const DetailPage({Key? key, required this.pokemon1}) : super(key: key);
  ...
  Scaffold _buildLandscapeBody(BuildContext context, String pokeballImageUrl) {
    return Scaffold(
      backgroundColor: UIhelper.getColorFromType(pokemon1.type![0]),
      body: SafeArea(
        child: Column(
                ...
                children: [
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        PokeNameType(pokemon1: pokemon1, pokemon: pokemon1,),
                        Expanded(
                          child: Hero(
                            tag: pokemon1.id!,
                            child: CachedNetworkImage(
                              imageUrl: pokemon1.img ?? '',
                              height: 0.4.sh,
                  ...
                  Expanded(
                      ...
                      child: Padding(
                        ...
                        child: PokeInformation(pokemon1: pokemon1),
                      )),
                ],
              ),
            ),
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            PokeNameType(pokemon: pokemon1, pokemon1: pokemon1,),
            SizedBox(
              height: 20.h,
            ),
            Expanded(
